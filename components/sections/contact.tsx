      ...
      <Container>
        <MotionUp delay={0.1}>
          ...
          <div className="flex sm:flex-nowrap flex-wrap mt-6 sm:mt-12">
              ...
              <div className="relative flex flex-wrap justify-center items-center w-full shadow-md">
                <div className="w-full px-6">
                  <h6 className="text-blue-100 italic font-bold text-xl uppercase">
                    believe in <span className="text-purple">Yourself</span>
                  </h6>
                </div>
            ...
            <div className="order-1 sm:order-2 w-full md:w-[40%] flex flex-col">
              <ContactForm className="mt-8 md:mt-0 md:ml-auto" />
            </div>
          </div>
        </MotionUp>
      </Container>
